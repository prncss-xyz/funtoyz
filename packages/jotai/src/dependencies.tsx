...
export function createContainerAtom<I extends Empty>() {
  ...
  function SUT({
    ...
    const containerPair = useMemo(
      () => hydrateTestContainerAtom(fn, parent),
      [fn, parent],
    );
    return <Hydrator containerPair={containerPair}>{children}</Hydrator>;
  }
