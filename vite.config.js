...
export default defineConfig({
    staged: {
        '*.{js,jsx,ts,tsx,cjs,mjs,mts,cts}': 'vp check --fix --no-error-on-unmatched-pattern',
        '*.{json,jsonc,json5,md,mdx,markdown,yaml,yml,css,less,scss,html,gql,graphql,hbs,handlebars,vue}': 'vp fmt --no-error-on-unmatched-pattern',
    },
    run: {
        tasks: {
            test: {
